...
openssl req -new -x509 -keyout kafka-ia-ca.key -out kafka-ia-ca.crt -days 999 -subj "/CN=$BROKERCN/OU=$SUBJOU/O=$SUBJO/L=$SUBJL/C=$SUBJC" -passin pass:$TRUSTSTOREPASSWORD -passout pass:$KEYPASSWORD
...
openssl x509 -req -CA kafka-ia-ca.crt -CAkey kafka-ia-ca.key -in kafka-ia-broker1.csr -out kafka-ia-broker1-signed.crt -days 9999 -CAcreateserial -passin pass:$KEYPASSWORD
...
openssl x509 -req -CA kafka-ia-ca.crt -CAkey kafka-ia-ca.key -in kafka-ia-producer.csr -out kafka-ia-producer-signed.crt -days 9999 -CAserial kafka-ia-ca.srl -passin pass:$KEYPASSWORD
...
openssl x509 -req -CA kafka-ia-ca.crt -CAkey kafka-ia-ca.key -in kafka-ia-consumer.csr -out kafka-ia-consumer-signed.crt -days 9999 -CAserial kafka-ia-ca.srl -passin pass:$KEYPASSWORD
